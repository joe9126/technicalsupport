...
<div class="row top-row bg-primary mb-2">
    <p class="text-center text-uppercase text-light fw-bold fs-1">PROFILE</p>
</div>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row mt-3">
                    <div class="col-sm-12">
                      <a class="btn btn-info disabled text-white" aria-disabled="true" href="#">
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      <h2 class="d-flex align-items-center mb-3">
                        <i class="fa fa-user-shield  mr-2"></i> Change Password</h2>
                      <hr class="hr mb-2">
                      ...
                      <div class="row justify-content-center mt-3">
                        ...
                        <div class="col-sm-4">
                          <button type="button" class="btn btn-block bg-info text-light">
